                ...
                <div class="col-lg-12 text-center text-lg-start">
                    <div class="footer-flex">
                        ...
                        <ul class="list-inline ">
                            ...
                            <li class="list-inline-item">
                                <a href="https://twitter.com/i/flow/login?redirect_after_login=%2FUdenzMENA" class="footer-social-icon"><i
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-auto">
                            <a style="color: white;" href="{{route('dentist.privacy')}}">Patient
                                Privacy Policy </a>
                        </div>
 ...
 <div class="footer-tagline">
                 ...
                 @csrf
                    ...
                    <div class="mb-2">
                        ...
                        <div class="position-set">
                            <input type="password" name="password" class="form-control input-password" placeholder="Enter Password"
                                id="inputPasseord" />
                                 <label id="inputPasseord-error" class="error" for="inputPasseord" style="color: red;display:none;">Please Enter Password</label>
    ...
    <div class="modal fade" id="signupModal" tabindex="-1" aria-hidden="true">
        ...
        <!-- javascript -->
        <script src="{{asset('public/new_front_assets/js/jquery.js')}}"></script>
        <script src="{{asset('public/new_front_assets/js/bootstrap.bundle.min.js')}}"></script>
        <!-- counter -->
        <script src="{{asset('public/new_front_assets/js/counter.init.js')}}"></script>
        <!-- swiper -->
        <script src="{{asset('public/new_front_assets/js/swiper-bundle.min.js')}}"></script>
        <script src="{{asset('public/new_front_assets/js/swiper.js')}}"></script>
        <script src="{{asset('public/new_front_assets/js/app.js')}}"></script>
        <!-- <script>
